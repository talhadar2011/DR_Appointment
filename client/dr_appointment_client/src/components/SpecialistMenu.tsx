...
export default function SpecialistMenu() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p className="font-semibold  text-gray-500 lg:mb-16 sm:text-xl dark:text-cyan-800 ">Explore the whole collection of open-source web components and elements built with the utility classNamees from Tailwind</p>
      </div> 
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-cyan-800 dark:border-gray-700">
              ...
              <div className="p-5">
                  ...
                  <span className="text-gray-500 dark:text-gray-200">CTO</span>
