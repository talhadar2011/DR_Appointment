...
export default function Footer() {
    return (
        <div>
            ...
            <footer className="p-4 bg-cyan-800 sm:p-6">
                <div className="mx-auto max-w-screen-xl">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <div className="flex items-center">
                                <img src={logo} className="mr-3 h-50" alt="DrAppointmentLogo" />
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <div className="hover:underline">Flowbite™</div>. All Rights Reserved.
                        </span>
